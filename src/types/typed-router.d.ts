...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/action-popup/block-website': RouteRecordInfo<'/action-popup/block-website', '/action-popup/block-website', Record<never, never>, Record<never, never>>,
    '/blocked/': RouteRecordInfo<'/blocked/', '/blocked', Record<never, never>, Record<never, never>>,
